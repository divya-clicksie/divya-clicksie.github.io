...
This is exactly why [Nubo](/) exists. Dedicated physical buttons for common newborn logs. No screen. No phone required. The data syncs to the app automatically when your phone is nearby.
...
Track feedings, sleep, and diapers. Use whatever is fastest for you. If that's a [quick-log tracker like Nubo](/), even better. The less friction there is, the more consistently you'll log, and consistency is what makes tracking useful.
