...
description: "Co-parenting newborn tracking keeps both parents informed without the exhausting 'did she eat?' conversations. The main logging options compared."
...
On iPhone with Nubo Plus, [Live Activities can bring that quick check to the Lock Screen](/blog/caregiver/baby-care-at-a-glance-shared-live-activity/). If your partner logged the feed, or a device button press has synced, you can see the latest feed or diaper without opening the app. The shared timeline is still there when you want the rest of the story.
