...
- **One nap at a time.** Try the crib for the first nap of the day, when sleep pressure is highest and the [wake window](/blog/sleep/newborn-wake-windows-by-age/) is shortest, and contact nap for the rest.
...
With the Nubo device on the armrest or side table, one tap starts the nap timer. You do not need to reach for anything, unlock anything, or move. If your iPhone is within reach and Nubo Plus is active, Live Activities show the sleep timer on the lock screen without opening the app. Dark room contact nap? [Midnight Ember](/blog/product/midnight-ember-night-mode/) keeps the screen amber so the light does not wake the baby on your chest.
