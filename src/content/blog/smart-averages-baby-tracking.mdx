...
The goal is not perfect data. It is accurate insight from imperfect data. One chaotic day should not wreck the number your pediatrician sees, and now it does not. When it is time for that appointment, [here's what else to have ready](/blog/tracking/what-to-bring-newborn-pediatrician-visit/).
