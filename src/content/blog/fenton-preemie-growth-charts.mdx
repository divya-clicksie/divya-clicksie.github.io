...
This post explains what Fenton charts are, why they exist, how corrected age changes the picture, and what you can actually do with the information.

## Why standard growth charts get preemies wrong

The growth charts used in most pediatric offices are the [WHO Child Growth Standards](https://www.who.int/tools/child-growth-standards), published in 2006 by the WHO Multicentre Growth Reference Study Group. They are excellent charts. They were built from a longitudinal study of healthy, breastfed, full-term infants across six countries. That last part is the problem.

Full-term means born at or after 39 weeks gestation. The WHO charts start at birth, which for their study population means 39-40 weeks of completed growth. When you plot a baby born at 28 weeks on a chart built for 40-week babies, you are comparing a child who had 12 fewer weeks of in-utero growth to peers who had the full runway.
...
This matters because growth and development milestones are driven by neurological maturity, not calendar time. A 32-week preemie at 4 months chronological age is developmentally closer to a full-term 2-month-old. Expecting them to weigh the same as a 4-month-old full-term baby is like asking a first-grader to keep up with a third-grader.

Corrected age applies to most developmental milestones until about age 2, and to growth charts until the preemie "catches up." Some preemies catch up quickly, others take years, and both trajectories can be perfectly healthy. The point is that growth velocity matters more than a single data point, and velocity only makes sense when you are measuring against the right baseline.

## How the Fenton growth chart works

The Fenton preterm growth chart, revised in 2013 by Tanis Fenton and Jae Kim, was built from a systematic review and meta-analysis of six large population-based surveys covering nearly 4 million births, including over 34,000 births before 30 weeks ([Fenton & Kim, BMC Pediatrics, 2013](https://pubmed.ncbi.nlm.nih.gov/23601190/)). It spans from 22 weeks post-menstrual age (PMA) through 50 weeks PMA, covering the entire NICU stay and the critical months after discharge.

A few things make the Fenton chart different from standard growth references.

### Built from actual preterm birth data

Instead of extrapolating backward from full-term measurements, the Fenton chart uses real size-at-birth data for each gestational age. A baby born at 26 weeks is compared to other babies born at 26 weeks, not to a hypothetical in-utero growth curve.

### Sex-specific curves

Male and female preemies grow at different rates, especially in head circumference. The Fenton chart provides separate curves for boys and girls, which the older Babson-Benda chart it replaced did not.
...
One of the most thoughtful details in the 2013 revision is that the Fenton chart was deliberately harmonized with the WHO growth standards at 50 weeks PMA (about 10 weeks corrected age). At that point, the Fenton curves smoothly converge with the WHO curves, meaning there is no jarring jump when your baby "graduates" from one chart to the other.

This matters because the growth goal for preterm infants is to eventually follow the same trajectory as their full-term peers. The Fenton chart tracks the journey from preterm birth to the point where the WHO chart takes over. The 2013 revision used data from the international Preterm Multicentre Growth study to smooth this transition, ensuring the handoff between charts does not create artificial dips or spikes in the percentile line.
...
In Nubo, you enter your baby's due date once during setup. From that point, every growth measurement you add is plotted against corrected age automatically. Weight, length, and head circumference each have their own chart with all seven percentile overlays (3rd through 97th). You do not have to calculate corrected age yourself or wonder whether the chart you found online is the right one. If your baby was born at 28 weeks and is now 4 months old, the app knows that means 42 weeks PMA and plots accordingly.

The value compounds over time. A single measurement is a dot. Six months of measurements is a trajectory. That trajectory is what the neonatologist actually cares about at your follow-up visits. Walking in with an accurate, corrected-age growth curve is more useful than walking in with a number from a chart that was never designed for your baby.

If you are [tracking feeds, sleep, and diapers alongside growth](/blog/tracking/why-track-baby-sleep-feeds-diapers/), the combination gives your care team a complete picture: how much she is eating, how she is sleeping, and how it all translates into growth.

## When to worry and when to breathe

A low percentile on the right chart is not automatically a problem. Percentiles describe where your baby falls relative to other babies of the same gestational age and sex. Someone has to be at the 10th percentile. That is how percentiles work.
...
- **Clinical context.** Preemies who were growth-restricted in utero have different catch-up expectations than preemies who were appropriate for gestational age at birth. Your neonatologist or pediatrician should interpret the chart in the context of your baby's specific history.
...
Preemie parents already carry more worry than most. Every gram gained feels monumental. Every feed that does not go perfectly feels like a setback. The least the medical system can do is measure progress against the right yardstick.
