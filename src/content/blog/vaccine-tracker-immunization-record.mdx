...
That division is intentional. Daily tracking should be fast and frictionless. Clinical records should be thorough and searchable. For a look at how Nubo's logging options divide the work, [see how the Nubo ecosystem fits together](/blog/product/nubo-ecosystem-how-it-works/).
