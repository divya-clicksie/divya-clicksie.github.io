...
## Free for every parent

What To Expect is free for every parent in Nubo. No subscription required.

The part of the app that tells exhausted parents what may be normal for this exact stage should not sit behind a paywall. That was the design decision from the start.
