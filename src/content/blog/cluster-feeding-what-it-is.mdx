...
And if even a button is too much because the side table is out of reach, Alexa can handle it from across the room: "Alexa, tell Newborn Tracker that she started nursing 5 minutes ago." Both hands occupied, phone on the charger, voice is the only option. For a deeper look at how to track nursing sessions across all three methods, [see our breastfeeding-specific guide](/blog/feeding/how-to-track-breastfeeding-without-phone/).
