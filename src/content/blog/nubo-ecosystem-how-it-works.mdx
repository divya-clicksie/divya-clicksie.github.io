...
For a full walkthrough of the buttons, the sync, and the range, see [how Nubo syncs over Bluetooth](/blog/product/nubo-bluetooth-sync/).
...
With Nubo Plus on iPhone, the most useful screen in the Nubo app is one you never navigate to. When you start a sleep or nursing timer, it appears on your lock screen via Live Activities, and in the Dynamic Island if your phone supports it.
...
The Lock Screen also answers questions between active timers. It shows recent feed and diaper details, including events another caregiver logged or that the device sent into the shared timeline. You can check the last feed before taking over from your partner without asking them to reconstruct the afternoon. For that handoff moment, see [baby care at a glance with Live Activities](/blog/caregiver/baby-care-at-a-glance-shared-live-activity/).
...
**2:00 PM.** The nanny puts the baby down for a nap. She taps the device on the crib rail. The sleep timer starts in your app and in the nanny's app. With Nubo Plus active on your iPhone, you can also see it on your lock screen via Live Activities.
